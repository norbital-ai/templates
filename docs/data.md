...
Work assignments load before dated Leave evidence; entry links and permanent contract seals
...
An entry, its correction and its payslip link must agree on that contract. Do not move an old
...
| ------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------------------------------------------------- |
| Work         | Work rules on the settings version (ordinary rate, bands with their incentive limits, limits, breaks, one citation), effective terms, shifts, schedules and dated Work entries | Preserve the actual dated assignment and attendance evidence; never apply a later pattern backwards |
...
Preserve both the original event date and any explicitly supplied pay period. Do not move an event
date to force a cutoff. The configured attendance window determines which Work dates are measured;
the family determines when an approved monetary entry is due.
...
and link evidence rather than making the original obligation payable again.
...
source selection and permanent links must also agree. List every unresolved source record and
