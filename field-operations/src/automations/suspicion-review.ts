...
// the house default — re-probe photo inference live if vision/structured behaviour changes).
// Adapter-qualified per the host model registry contract: `<adapter>/<provider-model>`.
const SUSPICION_REVIEW_MODEL = 'openrouter/deepseek/deepseek-v4.1-flash';
