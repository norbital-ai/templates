...
| `shift_definitions`, `shift_patterns`, `rosters`, `work_days` | roster vocabulary; cycles of whole weeks; the roster of record (one employment, one payroll cycle, whole or refused, outranks the pattern); the day's assignment, worked intervals, breaks, holiday link, roster link                                         |
