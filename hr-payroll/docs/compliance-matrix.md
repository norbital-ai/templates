...
| TW           | Labour insurance, occupational accident insurance, employment insurance, NHI, labour pension, withholding and work premiums | `statutory-golden-tw.test.ts`, `leave-entitlement-golden.test.ts`                                 | Dependant reductions now take effect the following January under art. 5, and leave conversion follows Enforcement Rules art. 24-1. Multiple coverage changes within a month and multi-credit transfers remain to revalidate. **Partial.**                   |
...
| --- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| C01 | Dated cash-out rules cover monthly and semi-monthly SG, MY, PH, VN and TW salaries, plus MY weekly wages; MY daily and hourly contracts now price from the preceding complete wage period (EA 1955 s.60I(1C)) and TW monthly cash-out follows Enforcement Rules art. 24-1. Unsupported frequencies and unclassified allowances stop payroll. ID has no binding daily divisor: PP 35/2021 art. 40(4)(a) grants the entitlement without a formula, the 2014 Kemnaker JDIH explanation (÷30) is an analogy, and ÷25 appears only in court practice. | Independent fractional-day, allowance, salary-change and delayed-payment tests are in `leave-encashment-valuation.test.ts`; the reference-wage selector and its refusals are covered by `reference-wages.test.ts`. ID remains blocked until an authority or a recorded employer policy is cited; variable arrangements stay unsupported. |
| C02 | Per-circumstance final-pay deadlines are declared on each settings version with their authority (SG ss.21–23, MY ss.20–21, PH DOLE LA 06-20, VN art.48, TW Enforcement Rules art.9) and the run warns when its pay date passes the applicable deadline.                                                                                                                                                                                                                                                                                          | The warning is tested in `final-pay-deadline.test.ts`. Establishing a supported final-pay process, a final HR cut-off and a correction procedure remains an operational requirement.                                                                                                                                                     |
| C03 | A settings version can declare its exit clearance predicate (`payroll.tax_clearance`, SG IR21, MY CP21/CP22A); departure processing raises an open disbursement hold for a matching leaver and an open hold blocks settlement until HR records the releasing directive and amount.                                                                                                                                                                                                                                                               | `public-seed-exit-encashment.integration.test.ts` and `payment-holds.test.ts` cover the hold, the block and the release rules. Filing the authority's form and reconciling the directive's amounts remain external evidence.                                                                                                             |
...
| C05 | Drift compares contribution rules, configuration, elections, work rules (including `ordinary_rate_reference`), required declarations and leave entitlements. It does not compare obligations, filing duties or every eligibility/base for every effective date.                                                                                                                                                                                                                                                                                  | Review the uncovered fields against official sources per effective date. The obligation register now records each version's duties, but an automated no-change result cannot close this requirement.                                                                                                                                     |
...
- **MY daily/hourly leave conversion and overtime** now read the preceding complete wage period
  (total wages earned ÷ days actually worked) under Employment Act 1955 s.60I(1C); a missing
  adjacent period stops calculation rather than falling back to a divisor. s.60I(1A) (÷26) and
  s.60I(1B) (÷6) remain the monthly and weekly arms. `statutory-golden-my.test.ts` and
  `reference-wages.test.ts` cover both.

- **TW leave conversion** follows Enforcement Rules of the Labour Standards Act art. 24-1: the
  normal-hours wage of the most recent month before year-end/termination divided by 30, with the
  original year-end basis preserved for carried credit; a mid-reference-month salary or allowance
  change stops valuation until the complete normal-wage record is supplied.

- **ID leave conversion is not differently valued**: research confirmed no binding daily divisor.
  PP 35/2021 art. 40(4)(a) grants the entitlement; the 2014 Kemnaker JDIH explanation uses ÷30
  expressly by analogy to UU 13/2003 art. 157; ÷25 appears only in cassation practice. The
  catalogue therefore stays without a profile.

- **Per-circumstance final-pay deadlines** are declared per settings version and evaluated over the
  final-service-day person: SG ss.21–23 (same day, else 3 days; resignation without notice 7 days),
  MY ss.20–21 (termination day, else 3 days), PH DOLE LA 06-20 (30 days), VN Labour Code art. 48
  (14 working days, extendable to 30), TW Enforcement Rules art. 9 (immediate).
  `final-pay-deadline.test.ts` pins the warnings and their authorities.

- **Exit clearance holds** come from a declared predicate: SG IR21 (Tax Clearance) and MY
  CP21/CP22A (s.83) raise an open `payment_holds` row for a matching leaver; an open hold blocks
  settlement until the releasing directive and amount are recorded. IRAS requires the IR21 at
  least a month before cessation and forbids payment until the Clearance Directive; LHDN holds
  money for 90 days after receiving the form unless it permits earlier payment.
