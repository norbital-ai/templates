<script lang="ts">
	/**
	 * One loan component: the pay line a loan recovers through — a staff advance, a festive advance,
	 * an air-ticket advance. There is no request family behind it, because a loan is not an event:
	 * `loans` carries the agreement and the engine emits one line per period from its schedule.
	 *
