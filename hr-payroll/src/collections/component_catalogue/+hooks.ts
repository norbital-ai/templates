...
/**
 * Components are the catalogue of one jurisdiction settings version. The row is the whole
...
export default {
	...
	delete: {
		perRecord: {
			before: {
				description:
					'Refuses deleting a component once its jurisdiction settings version is sealed.',
