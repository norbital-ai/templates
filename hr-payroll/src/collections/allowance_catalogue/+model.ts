...
export default defineModel(
	...
	{
		description:
			'The allowance catalogue of one jurisdiction settings version: code, nature, the treatment every statutory scheme gives it, eligibility, evidence, settlement route and the entitlement ceiling of the allowance raised against it. Sealed with its version; the run cites the version it priced against.',
		recordLabel: ['code'],
