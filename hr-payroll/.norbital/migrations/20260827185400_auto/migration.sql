...
CREATE TABLE "payslip_adjustments" (
	...
	"period" text NOT NULL,
	"source__obligation_id" uuid,
	"source__work_day_id" uuid,
	...
	"rate" numeric,
	"sequence" integer NOT NULL,
	CONSTRAINT "payslip_adjustments_source_reference_check" CHECK (num_nonnulls("source__obligation_id", "source__work_day_id", "source__leave_request_id") = 1)
);
...
--> statement-breakpoint
CREATE INDEX "obligations_employment_id_pay_period_index" ON "obligations" ("employment_id","pay_period");
--> statement-breakpoint
CREATE INDEX "obligations_pay_component_id_index" ON "obligations" ("pay_component_id");
--> statement-breakpoint
CREATE INDEX "obligations_employment_id_event_date_index" ON "obligations" ("employment_id","event_date");
--> statement-breakpoint
CREATE INDEX "obligations_terms_index" ON "obligations" ("terms");
--> statement-breakpoint
CREATE INDEX "obligations_reverses_obligation_id_index" ON "obligations" ("reverses_obligation_id") WHERE "reverses_obligation_id" IS NOT NULL;
--> statement-breakpoint
CREATE INDEX "obligations_reference_search_trgm_idx" ON "obligations" USING gin ("reference" gin_trgm_ops);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX "payslip_adjustments_pay_component_id_index" ON "payslip_adjustments" ("pay_component_id") WHERE "pay_component_id" IS NOT NULL;
--> statement-breakpoint
CREATE UNIQUE INDEX "payslip_adjustments_obligation_per_payslip" ON "payslip_adjustments" ("source__obligation_id","payslip_id") WHERE "source__obligation_id" IS NOT NULL;
--> statement-breakpoint
CREATE UNIQUE INDEX "payslip_adjustments_leave_request_per_payslip" ON "payslip_adjustments" ("source__leave_request_id","payslip_id") WHERE "source__leave_request_id" IS NOT NULL;
--> statement-breakpoint
CREATE UNIQUE INDEX "payslip_adjustments_work_day_band_per_payslip" ON "payslip_adjustments" ("source__work_day_id","payslip_id",coalesce("overtime_band", 'null'::jsonb)) WHERE "source__work_day_id" IS NOT NULL;
--> statement-breakpoint
CREATE INDEX "payslip_adjustments_source_obligation_ref_idx" ON "payslip_adjustments" ("source__obligation_id") WHERE "source__obligation_id" is not null;
--> statement-breakpoint
CREATE INDEX "payslip_adjustments_source_work_day_ref_idx" ON "payslip_adjustments" ("source__work_day_id") WHERE "source__work_day_id" is not null;
--> statement-breakpoint
CREATE INDEX "payslip_adjustments_source_leave_request_ref_idx" ON "payslip_adjustments" ("source__leave_request_id") WHERE "source__leave_request_id" is not null;
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "obligations" ADD CONSTRAINT "obligations_employment_id_employments_fk" FOREIGN KEY ("employment_id") REFERENCES "employments"("id");
--> statement-breakpoint
ALTER TABLE "obligations" ADD CONSTRAINT "obligations_pay_component_id_pay_components_fk" FOREIGN KEY ("pay_component_id") REFERENCES "pay_components"("id");
--> statement-breakpoint
ALTER TABLE "obligations" ADD CONSTRAINT "obligations_reverses_obligation_id_obligations_fk" FOREIGN KEY ("reverses_obligation_id") REFERENCES "obligations"("id");
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "payslip_adjustments" ADD CONSTRAINT "payslip_adjustments_source_obligation_fk" FOREIGN KEY ("source__obligation_id") REFERENCES "obligations"("id") ON DELETE RESTRICT;
--> statement-breakpoint
ALTER TABLE "payslip_adjustments" ADD CONSTRAINT "payslip_adjustments_source_work_day_fk" FOREIGN KEY ("source__work_day_id") REFERENCES "work_days"("id") ON DELETE RESTRICT;
--> statement-breakpoint
ALTER TABLE "payslip_adjustments" ADD CONSTRAINT "payslip_adjustments_source_leave_request_fk" FOREIGN KEY ("source__leave_request_id") REFERENCES "leave_requests"("id") ON DELETE RESTRICT;
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "payslip_adjustments" ADD CONSTRAINT "payslip_adjustments_pay_component_id_pay_components_fk" FOREIGN KEY ("pay_component_id") REFERENCES "pay_components"("id");
--> statement-breakpoint
