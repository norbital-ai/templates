...
const SCHEDULING_README = [
	...
	'',
	'• Planned hours are worked hours: the statutory ceilings below count the shift’s paid hours',
	'  plus the day’s planned overtime.',
	'',
	...
	'  (e.g. 72 a month, all overtime included), and any monthly ceiling that does not split.',
	'',
	'What splits — incentive hours',
	'',
	'Two ceilings are not refused here. The import splits each day’s total in date order: the hours',
	'within them are stored as overtime, the rest as incentive hours, which payroll pays on the',
	'INCENTIVE line at the rate of the band they fall in:',
	'• the monthly overtime ceiling (e.g. 104 hours a month);',
	'• a daily limit a rate band names (e.g. 11 net hours a day, or 4 overtime hours a day).',
	'',
	'Accepted values',
	'',
