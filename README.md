...
| Settings → Catalog  | Review family definitions within the settings lineage; a money catalogue row says who may raise it and up to what ceiling, and a leave row who earns how many days, as predicates over the contract's terms and `grade`; a leave is paid or not, with one scheme matrix for its unpaid and encashed days; the work row is the rate of pay, the overtime regime and one scheme matrix for salary, overtime, excess overtime and absence, cited once |
