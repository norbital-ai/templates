...
CREATE TABLE "bonus_requests" (
	...
	"component_catalogue_id" uuid NOT NULL,
	"amount" numeric NOT NULL,
	"awarded_on" timestamp with time zone NOT NULL,
	"note" text,
	"pay_period" text
);
...
CREATE TABLE "correction_requests" (
	...
	"component_catalogue_id" uuid NOT NULL,
	"amount" numeric NOT NULL,
	"corrected_on" timestamp with time zone NOT NULL,
	"corrects_adjustment_id" uuid NOT NULL,
...
CREATE TABLE "payslip_adjustments" (
	...
	"input__bonus_request_input_id" uuid,
	"input__arrears_request_input_id" uuid,
	"input__correction_request_input_id" uuid,
	...
	"sequence" integer NOT NULL,
	CONSTRAINT "payslip_adjustments_input_reference_check" CHECK (num_nonnulls("input__work_day_input_id", "input__claim_request_input_id", "input__allowance_request_input_id", "input__bonus_request_input_id", "input__arrears_request_input_id", "input__correction_request_input_id", "input__leave_request_input_id", "input__loan_repayment_input_id") = 1)
);
...
--> statement-breakpoint
CREATE TABLE "payslip_arrears_request_inputs" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid(),
	"created_at" timestamp with time zone DEFAULT now(),
	"updated_at" timestamp with time zone DEFAULT now(),
	"sys_period" tstzrange DEFAULT tstzrange(CURRENT_TIMESTAMP, NULL, '[)') NOT NULL,
	...
	"approval_id" uuid,
	"payslip_id" uuid NOT NULL,
	"arrears_request_id" uuid NOT NULL,
	"period" text NOT NULL
);

--> statement-breakpoint
CREATE TABLE "payslip_bonus_request_inputs" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid(),
	"created_at" timestamp with time zone DEFAULT now(),
	"updated_at" timestamp with time zone DEFAULT now(),
	"sys_period" tstzrange DEFAULT tstzrange(CURRENT_TIMESTAMP, NULL, '[)') NOT NULL,
	...
	"approval_id" uuid,
	"payslip_id" uuid NOT NULL,
	"bonus_request_id" uuid NOT NULL,
	"period" text NOT NULL
);
...
--> statement-breakpoint
CREATE TABLE "payslip_correction_request_inputs" (
	"id" uuid PRIMARY KEY DEFAULT gen_random_uuid(),
	"created_at" timestamp with time zone DEFAULT now(),
	"updated_at" timestamp with time zone DEFAULT now(),
	"sys_period" tstzrange DEFAULT tstzrange(CURRENT_TIMESTAMP, NULL, '[)') NOT NULL,
...
--> statement-breakpoint
CREATE INDEX "allowance_requests_component_catalogue_id_idx" ON "allowance_requests" ("component_catalogue_id");
--> statement-breakpoint
CREATE INDEX "allowance_requests_employment_id_idx" ON "allowance_requests" ("employment_id");
--> statement-breakpoint
CREATE INDEX "arrears_requests_employment_id_pay_period_index" ON "arrears_requests" ("employment_id","pay_period");
--> statement-breakpoint
CREATE INDEX "arrears_requests_employment_id_settled_on_index" ON "arrears_requests" ("employment_id","settled_on");
--> statement-breakpoint
CREATE INDEX "arrears_requests_component_catalogue_id_idx" ON "arrears_requests" ("component_catalogue_id");
--> statement-breakpoint
CREATE INDEX "bonus_requests_employment_id_pay_period_index" ON "bonus_requests" ("employment_id","pay_period");
--> statement-breakpoint
CREATE INDEX "bonus_requests_employment_id_awarded_on_index" ON "bonus_requests" ("employment_id","awarded_on");
--> statement-breakpoint
CREATE INDEX "bonus_requests_component_catalogue_id_idx" ON "bonus_requests" ("component_catalogue_id");
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX "claim_requests_component_catalogue_id_idx" ON "claim_requests" ("component_catalogue_id");
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX "correction_requests_employment_id_pay_period_index" ON "correction_requests" ("employment_id","pay_period");
--> statement-breakpoint
CREATE INDEX "correction_requests_employment_id_corrected_on_index" ON "correction_requests" ("employment_id","corrected_on");
--> statement-breakpoint
CREATE INDEX "correction_requests_component_catalogue_id_idx" ON "correction_requests" ("component_catalogue_id");
--> statement-breakpoint
CREATE INDEX "correction_requests_corrects_adjustment_id_idx" ON "correction_requests" ("corrects_adjustment_id");
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX "payslip_adjustments_input_bonus_request_input_ref_idx" ON "payslip_adjustments" ("input__bonus_request_input_id") WHERE "input__bonus_request_input_id" is not null;
--> statement-breakpoint
CREATE INDEX "payslip_adjustments_input_arrears_request_input_ref_idx" ON "payslip_adjustments" ("input__arrears_request_input_id") WHERE "input__arrears_request_input_id" is not null;
--> statement-breakpoint
CREATE INDEX "payslip_adjustments_input_correction_request_input_ref_idx" ON "payslip_adjustments" ("input__correction_request_input_id") WHERE "input__correction_request_input_id" is not null;
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX "payslip_arrears_request_inputs_payslip_id_arrears_request_id_index" ON "payslip_arrears_request_inputs" ("payslip_id","arrears_request_id");
--> statement-breakpoint
CREATE UNIQUE INDEX "payslip_arrears_request_inputs_arrears_request_id_index" ON "payslip_arrears_request_inputs" ("arrears_request_id");
--> statement-breakpoint
CREATE UNIQUE INDEX "payslip_bonus_request_inputs_payslip_id_bonus_request_id_index" ON "payslip_bonus_request_inputs" ("payslip_id","bonus_request_id");
--> statement-breakpoint
CREATE UNIQUE INDEX "payslip_bonus_request_inputs_bonus_request_id_index" ON "payslip_bonus_request_inputs" ("bonus_request_id");
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX "payslip_correction_request_inputs_payslip_id_correction_request_id_index" ON "payslip_correction_request_inputs" ("payslip_id","correction_request_id");
--> statement-breakpoint
CREATE UNIQUE INDEX "payslip_correction_request_inputs_correction_request_id_index" ON "payslip_correction_request_inputs" ("correction_request_id");
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "allowance_requests" ADD CONSTRAINT "allowance_requests_component_catalogue_id_component_catalogue_fk" FOREIGN KEY ("component_catalogue_id") REFERENCES "component_catalogue"("id");
--> statement-breakpoint
ALTER TABLE "arrears_requests" ADD CONSTRAINT "arrears_requests_employment_id_employments_fk" FOREIGN KEY ("employment_id") REFERENCES "employments"("id");
--> statement-breakpoint
ALTER TABLE "arrears_requests" ADD CONSTRAINT "arrears_requests_component_catalogue_id_component_catalogue_fk" FOREIGN KEY ("component_catalogue_id") REFERENCES "component_catalogue"("id");
--> statement-breakpoint
ALTER TABLE "bonus_requests" ADD CONSTRAINT "bonus_requests_employment_id_employments_fk" FOREIGN KEY ("employment_id") REFERENCES "employments"("id");
--> statement-breakpoint
ALTER TABLE "bonus_requests" ADD CONSTRAINT "bonus_requests_component_catalogue_id_component_catalogue_fk" FOREIGN KEY ("component_catalogue_id") REFERENCES "component_catalogue"("id");
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "claim_requests" ADD CONSTRAINT "claim_requests_component_catalogue_id_component_catalogue_fk" FOREIGN KEY ("component_catalogue_id") REFERENCES "component_catalogue"("id");
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "correction_requests" ADD CONSTRAINT "correction_requests_employment_id_employments_fk" FOREIGN KEY ("employment_id") REFERENCES "employments"("id");
--> statement-breakpoint
ALTER TABLE "correction_requests" ADD CONSTRAINT "correction_requests_component_catalogue_id_component_catalogue_fk" FOREIGN KEY ("component_catalogue_id") REFERENCES "component_catalogue"("id");
--> statement-breakpoint
ALTER TABLE "correction_requests" ADD CONSTRAINT "correction_requests_corrects_adjustment_id_payslip_adjustments_fk" FOREIGN KEY ("corrects_adjustment_id") REFERENCES "payslip_adjustments"("id");
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "payslip_adjustments" ADD CONSTRAINT "payslip_adjustments_input_bonus_request_input_fk" FOREIGN KEY ("input__bonus_request_input_id") REFERENCES "payslip_bonus_request_inputs"("id") ON DELETE CASCADE;
--> statement-breakpoint
ALTER TABLE "payslip_adjustments" ADD CONSTRAINT "payslip_adjustments_input_arrears_request_input_fk" FOREIGN KEY ("input__arrears_request_input_id") REFERENCES "payslip_arrears_request_inputs"("id") ON DELETE CASCADE;
--> statement-breakpoint
ALTER TABLE "payslip_adjustments" ADD CONSTRAINT "payslip_adjustments_input_correction_request_input_fk" FOREIGN KEY ("input__correction_request_input_id") REFERENCES "payslip_correction_request_inputs"("id") ON DELETE CASCADE;
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "payslip_arrears_request_inputs" ADD CONSTRAINT "payslip_arrears_request_inputs_payslip_id_payslips_fk" FOREIGN KEY ("payslip_id") REFERENCES "payslips"("id") ON DELETE CASCADE;
--> statement-breakpoint
ALTER TABLE "payslip_arrears_request_inputs" ADD CONSTRAINT "payslip_arrears_request_inputs_arrears_request_id_arrears_requests_fk" FOREIGN KEY ("arrears_request_id") REFERENCES "arrears_requests"("id");
--> statement-breakpoint
ALTER TABLE "payslip_bonus_request_inputs" ADD CONSTRAINT "payslip_bonus_request_inputs_payslip_id_payslips_fk" FOREIGN KEY ("payslip_id") REFERENCES "payslips"("id") ON DELETE CASCADE;
--> statement-breakpoint
ALTER TABLE "payslip_bonus_request_inputs" ADD CONSTRAINT "payslip_bonus_request_inputs_bonus_request_id_bonus_requests_fk" FOREIGN KEY ("bonus_request_id") REFERENCES "bonus_requests"("id");
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "payslip_correction_request_inputs" ADD CONSTRAINT "payslip_correction_request_inputs_payslip_id_payslips_fk" FOREIGN KEY ("payslip_id") REFERENCES "payslips"("id") ON DELETE CASCADE;
--> statement-breakpoint
ALTER TABLE "payslip_correction_request_inputs" ADD CONSTRAINT "payslip_correction_request_inputs_correction_request_id_correction_requests_fk" FOREIGN KEY ("correction_request_id") REFERENCES "correction_requests"("id");
--> statement-breakpoint
