...
const LABEL = 'crm-sweep';
const ORGANIZATION = 'CRM public seed';

/** The columns whose value genuinely is a structured document, so the JSON editor is right. */
const STRUCTURED_FIELDS = new Set(['effective_range', 'metadata', 'payload', 'terms', 'address']);
 ...
 */
const NO_REPRESENTATION = new Set(['accounts', 'suppliers']);
