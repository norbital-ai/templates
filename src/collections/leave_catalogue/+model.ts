...
export default defineModel(
	...
	{
		description:
			'One leave of one jurisdiction settings version: its eligibility, service bands, accrual, year-end and exit settlement, and whether it is the law (cited) or company rule. Sealed with its version.',
