...
<svelte:head>
	<meta
		name="bolt:banner"
		content="/__bolt/request/api/template-seed-assets/field-operations/record-media/sites-banner.svg"
	/>
</svelte:head>

{#snippet generalInformation()}
	<CollectionForm client={collectionClient} collection="sites" defaultValues={record ?? undefined}>
...
<RecordShell
	...
	tabs={record
		...
		: undefined}
>
	{#if record == null}{@render createSite()}{/if}
</RecordShell>
