...
/**
 * What happens to a leave year's unused balance.
 *
 ...
 *               null carries the whole balance (SG: the statute guarantees the carry, so the row
 *               states no cap); `expiry_months` 0 never expires.
