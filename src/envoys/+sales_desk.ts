 ...
 * That reuse is deliberate and it is the whole of the security statement: *what a stranger can do
 * to this database is what a sales rep can do*, and the way to narrow it is to give this envoy a
 * narrower policy set, not to add a rule here.
 *
