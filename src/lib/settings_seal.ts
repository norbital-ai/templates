 ...
 *
 * Each child collection of `jurisdiction_settings` (schemes, bands through their scheme, leave
 * types, pay components, holidays) calls this from its `mutate.before` and `delete.before`. It
